...
[gqlgen](https://github.com/stealthmodesoft/gqlgen) is a Go library for building GraphQL servers without any fuss.<br/>
...
2. Add `github.com/stealthmodesoft/gqlgen` to your [project's tools.go](https://github.com/golang/go/wiki/Modules#how-can-i-track-tool-dependencies-for-a-module)

       printf '// +build tools\npackage tools\nimport _ "github.com/stealthmodesoft/gqlgen"' | gofmt > tools.go
       go mod tidy
...
More help to get started:
 ...
 - [Real-world examples](https://github.com/stealthmodesoft/gqlgen/tree/master/_examples) show how to create GraphQL applications
 - [Reference docs](https://pkg.go.dev/github.com/stealthmodesoft/gqlgen) for the APIs

## Reporting Issues

If you think you've found a bug, or something isn't behaving the way you think it should, please raise an [issue](https://github.com/stealthmodesoft/gqlgen/issues) on GitHub.

## Contributing

We welcome contributions, Read our [Contribution Guidelines](https://github.com/stealthmodesoft/gqlgen/blob/master/CONTRIBUTING.md) to learn more about contributing to **gqlgen**
...
models:
  ID: # The GraphQL type ID is backed by
    model:
      - github.com/stealthmodesoft/gqlgen/graphql.IntID # a go integer
      - github.com/stealthmodesoft/gqlgen/graphql.ID # or a go string
```

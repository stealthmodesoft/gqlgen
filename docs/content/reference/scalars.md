...
For user defined types you can implement the [graphql.Marshaler](https://pkg.go.dev/github.com/stealthmodesoft/gqlgen/graphql#Marshaler) and [graphql.Unmarshaler](https://pkg.go.dev/github.com/stealthmodesoft/gqlgen/graphql#Unmarshaler) or implement the [graphql.ContextMarshaler](https://pkg.go.dev/github.com/stealthmodesoft/gqlgen/graphql#ContextMarshaler) and [graphql.ContextUnmarshaler](https://pkg.go.dev/github.com/stealthmodesoft/gqlgen/graphql#ContextUnmarshaler) interfaces and they will be called.
...
See the [_examples/scalars](https://github.com/stealthmodesoft/gqlgen/tree/master/_examples/scalars) package for more examples.
